...
final class Employee extends Model
{
    ...
    private function searchWhere(string $query, string $status, array &$params): string
    {
        ...
        if ($query !== '') {
            $conditions[] = '(e.employee_code LIKE :query OR e.first_name LIKE :query OR e.last_name LIKE :query OR e.email LIKE :query OR d.department_name LIKE :query OR ds.designation_name LIKE :query)';
            $params['query'] = '%' . $query . '%';
        }
